...
function readPreferenceHeaderValue(metadataHeader) {
...
function readPreferenceHeaderValues(metadataHeader) {
  ...
  values = _.map(values, function(value) {
    return readPreferenceHeaderValue(value);
  });
  return values;
}
...
function readClientInfo(rawRequest) {
  ...
  if (expectHeader != null) {
    clientInfo.expectations
      = readPreferenceHeaderValues(expectHeader);
  }
...
function readEntity(rawRequest, request) {
  ...
  entity.mediaType = readPreferenceHeaderValue(contentTypeHeader);
...
headers.fillHeadersAndContentInResponse = function(rawResponse, response) {
  if (response.entity != null) {
    rawResponse.setHeader('Content-Type', response.entity.mediaType);
